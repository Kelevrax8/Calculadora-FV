...
INSERT INTO inverters
    (manufacturer_id, model,
     pmax_dc_input, max_dc_voltage, max_input_current,
     max_short_circuit_current, nominal_ac_power, mppt_count)
VALUES
    ((SELECT id FROM manufacturers WHERE name = 'Growatt'),
     'MIN 3000TL-X', 3600.00, 600.00, 11.00, 16.50, 3000.00, 1),

    ((SELECT id FROM manufacturers WHERE name = 'Growatt'),
     'MIN 6000TL-X', 7200.00, 600.00, 12.50, 18.75, 6000.00, 2),

    ((SELECT id FROM manufacturers WHERE name = 'Growatt'),
     'MID 15KTL3-X', 18750.00, 1000.00, 20.00, 30.00, 15000.00, 3),

    ((SELECT id FROM manufacturers WHERE name = 'Growatt'),
     'MID 25KTL3-X', 30000.00, 1000.00, 26.00, 39.00, 25000.00, 4);
...
VALUES
    ((SELECT id FROM manufacturers WHERE name = 'SMA Solar'),
     'Sunny Boy 3.0', 4500.00, 600.00, 10.00, 15.00, 3000.00, 2),

    ((SELECT id FROM manufacturers WHERE name = 'SMA Solar'),
     'Sunny Boy 5.0', 7500.00, 600.00, 12.50, 20.00, 5000.00, 2),

    ((SELECT id FROM manufacturers WHERE name = 'SMA Solar'),
     'Sunny Tripower 10.0', 15000.00, 1000.00, 12.00, 20.00, 10000.00, 3),

    ((SELECT id FROM manufacturers WHERE name = 'SMA Solar'),
     'Sunny Tripower 25000TL', 30000.00, 1000.00, 27.00, 40.50, 25000.00, 3);
...
VALUES
    ((SELECT id FROM manufacturers WHERE name = 'SolarEdge'),
     'SE5K-RWS', 6750.00, 480.00, 18.00, 27.00, 4999.00, 1),

    ((SELECT id FROM manufacturers WHERE name = 'SolarEdge'),
     'SE10K-RWS', 13500.00, 480.00, 27.50, 41.25, 9999.00, 1),

    ((SELECT id FROM manufacturers WHERE name = 'SolarEdge'),
     'SE17K', 20400.00, 1000.00, 32.50, 48.75, 17000.00, 2);
...
VALUES
    ((SELECT id FROM manufacturers WHERE name = 'Fronius'),
     'Primo 5.0-1', 7500.00, 600.00, 12.50, 18.75, 5000.00, 2),

    ((SELECT id FROM manufacturers WHERE name = 'Fronius'),
     'Symo 10.0-3-M', 15000.00, 800.00, 27.00, 40.50, 10000.00, 2),

    ((SELECT id FROM manufacturers WHERE name = 'Fronius'),
     'Tauro Eco 15.0-3-D', 22500.00, 1000.00, 33.00, 49.50, 15000.00, 2);
...
VALUES
    ((SELECT id FROM manufacturers WHERE name = 'Huawei'),
     'SUN2000-5KTL-L1', 6500.00, 600.00, 13.00, 19.50, 5000.00, 2),

    ((SELECT id FROM manufacturers WHERE name = 'Huawei'),
     'SUN2000-12KTL-M2', 18000.00, 1100.00, 22.00, 33.00, 12000.00, 3),

    ((SELECT id FROM manufacturers WHERE name = 'Huawei'),
     'SUN2000-30KTL-M3', 40000.00, 1100.00, 26.00, 39.00, 30000.00, 4);
